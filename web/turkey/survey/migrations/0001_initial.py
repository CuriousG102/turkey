# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-09-16 16:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external', models.BooleanField(default=False, help_text='If the task is not external, we will host itand you can design it on our platform. If it isexternal, you should mark this true, and we willprovide you with embed code to use on your HIT with your selected auditors.', verbose_name='External Hit')),

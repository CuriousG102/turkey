# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-04-10 05:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('auditordata_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='survey.AuditorData')),
                ('within_delay', models.IntegerField(blank=True, help_text='whether the user typed within the delay period', null=True, verbose_name='within typing delay')),
            ],
            options={
                'abstract': False,
                'ordering': ['-updated', '-created'],

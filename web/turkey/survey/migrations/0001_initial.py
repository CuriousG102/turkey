# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-05 02:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='StepMultipleAnswersResponse',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('text', models.TextField(help_text='Text for one of the responses to a Multiple Answers Step', verbose_name='Multiple Answers Response Text')),
                ('order', models.IntegerField(blank=True, help_text='Controls the order that responses linked to a Multiple Answers Step are to be rendered. The field can be left blank but this only really makes sense if you randomize order of responses in the Multiple Answers Step', null=True, verbose_name='Response Number')),
                ('multiple_answers_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='survey.StepMultipleAnswers', verbose_name='Associated Multiple Answers Step for Response')),
            ],
            options={
                'verbose_name_plural': 'Steps',
                'abstract': False,
                'verbose_name': 'Multiple Answers Step Response',
                'ordering': ['order'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('survey_name', models.CharField(blank=True, help_text="This is exposed to the user: Name of the survey they're taking. It is an optional field, as it is not relevant if this is an external task.", max_length=144, null=True, verbose_name='Survey Name')),
                ('external', models.BooleanField(default=False, help_text='If the task is not external, we will host it and you can design it on our platform. If it is external, you should mark this true, and we will provide you with embed code to use on your HIT with your selected auditors.', verbose_name='External Hit')),
                ('published', models.BooleanField(default=False, help_text='Activate the task and start collecting data. Be warned: after there are task interactions you will not be able to modify auditors or steps (if applicable). You cannot unpublish a task once there are responses', verbose_name='Published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.IntegerField(help_text='timestamp of this keypress event', verbose_name='keypresses specific timestamp')),
            ],
            options={
                'abstract': False,
                'ordering': ['-updated', '-created'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.IntegerField(help_text='timestamp of this mouse movement', verbose_name='mouse movement timestamp')),
            ],
            options={
                'abstract': False,
                'ordering': ['-updated', '-created'],
        ...
        migrations.AddField(
            model_name='taskinteraction',
            name='token',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='survey.Token'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='stepmultipleanswersdata',
            name='response',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='survey.StepMultipleAnswersResponse'),
        ),
        migrations.AddField(
